...
def publishHit(folder, imgSet, client, ann, upTime):
    ...
    response = client.create_hit(
        ...
        AssignmentDurationInSeconds = 3153600,
        Reward ='0.01',
        Title = 'Draw Polygons Around Buildings',
        Keywords = 'Computer Vision, Image, Annotation, Labelling, Polygons, Satellite, UNOSAT',
        Description = 'Draw Polygons around buildings',
        Question = qxml
    )
...
def publishAll(folderName, numPer, client, ann, upTime, productionBool):
    ...
    hitfileFolder = topLevelDir + '/' +folderName
    if (productionBool):
